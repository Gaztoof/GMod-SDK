...
inline void* CTakeDamageInfo::GetInflictor() const
{
	return m_hInflictor;
}
...
inline void* CTakeDamageInfo::GetAttacker() const
{
	return m_hAttacker;
}
...
inline void* CTakeDamageInfo::GetWeapon() const
{
	return m_hWeapon;
}
...
// Inlines.
// -------------------------------------------------------------------------------------------------- //
inline void* CMultiDamage::GetTarget() const
{
	return m_hTarget;
}
