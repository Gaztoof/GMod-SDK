...
public:
	...
	/*386*/	virtual void* GetBulletType(void) = 0;
	/*387*/	virtual void* GetBulletSpread(void) = 0;
	/*388*/	virtual void* GetBulletSpread(WeaponProficiency_t) = 0;
	/*389*/	virtual void* GetSpreadBias(WeaponProficiency_t) = 0;
	...
	/*403*/	virtual void* GetDamage(float, int) = 0;
	...
	/*429*/	virtual void* GetName(void)const = 0;
	/*430*/	virtual void* GetPrintName(void)const = 0;
